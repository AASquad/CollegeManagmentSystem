...
<div class="row">
    <div class="col-lg-12">
        <div class="form-group">
                                ...
                                <input type="text" name="fyclg" class="form-control" required>
                                <label>Address</label>
                                <textarea class="form-control" rows="3"  name="fyclgadd" required></textarea>
                                <label>Month and passing year</label>
                                <input type="text" name="fypassing" placeholder="eg. March-2018" class="form-control" required>
                                <label>No. of Attempt</label>
                                <input type="number" name="fyattempt" placeholder="" class="form-control" required>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                                <th>Subject Name</th>
                                                <td><input type="text" name="fysem1subname1" required/></td>
                                                <td><input type="text" name="fysem1subname2" required/></td>
                                                <td><input type="text" name="fysem1subname3" required/></td>
                                                <td><input type="text" name="fysem1subname4" required/></td>
                                        ...
                                        //si6
                                           if(document.getElementById('oo16').value=="") {
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" id="fysempercent"  name="fypercentage" readonly/><br>
                                                    </td>
                                            <script>
                                            function persem1(){    
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                                <th>Subject Name</th>
                                                <td><input type="text" name="fysem2subname1" required/></td>
                                                <td><input type="text" name="fysem2subname2" required/></td>
                                                <td><input type="text" name="fysem2subname3" required/></td>
                                                <td><input type="text" name="fysem2subname4"  required/></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" id="mm2total"   name="fysem2marktotal" readonly/></td>
                                            </tr>
                                            <script>
                                        ...
                                        //si6
                                           if(document.getElementById('oo26').value=="") {
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" id="fysem2percent"  name="fypercentage2" readonly/><br>
                                                    </td>
                                            <script>
                                            function per1(){    
